	    ...
	    <div class="contBlock">
	        <div class="sectionTop">
                ...
                <li>
                    ...
                    <input name="" type="text" value="${sessionScope.session.mbId}" maxlength="50" readonly="readonly" class="input-text" style="width: 410px;" />
                </li>
                <li>
                    <span class="dt">닉네임</span>
                    <input name="" type="text" maxlength="20" class="input-text" style="width: 410px;" />
                </li>
            </ul>
        </div>
        <dl class="i_r">
            <dt>소개</dt>
            <dd>
                <textarea name="" rows="2" cols="20" class="textarea" title="소개" placeholder="자신을 어필할 수 있는 공간입니다.
자격증이나 경력사항을 상세히 적어주시면 구매자분께 더 어필할 수 있습니다.
(단, 연락처를 기제하여 직거래를 유도하려고 하는 경우 제제를 당할 수 있습니다.)" style="height:206px;width:710px;width: 100%; height: 198px;">${dto.mbAbout}</textarea></dd>
        </dl>
