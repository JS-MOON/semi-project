...
<div class="primaryContents myProfile">
    ...
    <form action="UpdateMyprofile.do" method="post">
	    <div class="contBlock">
	        <div class="sectionTop">
	            ...
	            <ul class="i_r">
	                <li>
	                    ...
	                    <input name="ctl00$ContentPlaceHolder1$WUC_MyProfile1$txtID" type="text" value="${dto.mbId}" maxlength="50" readonly="readonly" id="ContentPlaceHolder1_WUC_MyProfile1_txtID" class="input-text" style="width: 410px;" />
	                </li>
	                <li>
	                ...
	                <li>
	                    ...
	                    <input name="ctl00$ContentPlaceHolder1$WUC_MyProfile1$txtNickname" type="text" value=" ${dto.mbNickName}" maxlength="20" id="ContentPlaceHolder1_WUC_MyProfile1_txtNickname" class="input-text" style="width: 410px;" />
	                </li>
	            </ul>
	        </div>
	        <dl class="i_r">
	...
	(단, 연락처를 기제하여 직거래를 유도하려고 하는 경우 제제를 당할 수 있습니다.)" style="height:206px;width:710px;width: 100%; height: 198px;">
	        ...
	        <div class="btnArea al_r">
	           <!--  <a id="ContentPlaceHolder1_WUC_MyProfile1_lbtnSave" class="btnType12"
	             href="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions
	             (&quot;ctl00$ContentPlaceHolder1$WUC_MyProfile1$lbtnSave&quot;, &quot;&quot;, 
	             true, &quot;MyProfile&quot;, &quot;&quot;, false, true))" ><span>저장</span></a> -->
